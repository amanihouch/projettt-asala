        ...
        <div class="product-main-large">
          ...
          <div class="product-info-large">
            ...
            <div class="option-section-large">
              ...
              <!-- Quantité disponible mise à jour automatiquement -->
              <div v-if="getAvailableStock() > 0" class="stock-available-large">
                ✅ المتوفر حالياً: <strong>{{ getAvailableStock() }} {{ getUnitLabel(product.unit) }}</strong>
              </div>
              <div v-else class="stock-unavailable-large">
                ❌ غير متوفر حالياً
              </div>
            </div>
